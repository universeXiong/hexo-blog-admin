<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="left" :label="$t('imagesManage.imageList.table.preview.columnName')">
        <template slot-scope="scope">
          <img class="preview" :src="scope.row.url" alt="">
        </template>
      </el-table-column>
      <el-table-column align="left" :label="$t('imagesManage.imageList.table.filename.columnName')">
        <template slot-scope="scope">
